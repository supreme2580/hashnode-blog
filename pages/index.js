  ...
  return(
    ...
    <Head>
      ...
      <div className="bg-white border-b-2 border-zinc-300 pb-4">
        <div className="bg-black px-5 pt-4 h-auto flex flex-col space-y-4">
              <div className="w-full bg-black flex justify-between">
                  <div className="flex items-center h-full w-full justify-between space-x-5">
                    <div className="hover:cursor-pointer flex items-center space-x-4 group">
                      <img
                        ...
                        className="w-auto h-auto max-w-12 max-h-12 rounded-full group-hover:cursor-pointer"
                      />
                      <div className="text-2xl font-semibold sm:block hidden group-hover:cursor-pointer">Victor Omorogbe</div>
                    </div>
      ...
      <div className="bg-zinc-100 p-10 flex flex-col space-y-5">
        ...
        <div className="flex space-x-1 sm:space-x-5 text-zinc-700 justify-center items-center">
